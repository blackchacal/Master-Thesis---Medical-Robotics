...
\documentclass[
  ...
  biblatex={            % Options for biblatex (see biblatex documentation)
    ...
    issn=false          % Hide ISSN from references
  },
...
% use [f] for female and [m] for male
\adviser[m]{Prof. Dr. Rui Cortesão}{Professor Auxiliar com Agregação}{\\& Instituto de Sistemas e Robótica, Universidade de Coimbra} 
